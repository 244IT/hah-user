  ...
  <div class="study-detail">
    ...
    <div class="center">
      ...
      <h1 class="center-title">
        {{ info.book }}-{{ info.series }}-{{ info.section }}
      </h1>
      ...
      <section id="word" class="section">
        ...
        <div class="word-content">
          <ol class="word-list">
            <li
              v-for="(item, index) in info.words"
              :key="index"
              class="word-item"
            >
    ...
    <div class="right">
      ...
      <div class="tool">
        ...
        <ul>
          <li class="tool-item" v-for="(item, index) in tools" :key="index">
  ...
  data() {
    return {
      ...
      info: {
        ...
        audioUrl: "",
        original:
          "Last week I went to the theatre. I had a very good seat. The play was very interesting. I did not enjoy it. A young man and a young woman were sitting behind me. They were talking loudly. I got very angry. I could not hear the actors. I turned round. I looked at the man and the woman angrily. They did not pay any attention. In the end, I could not bear it. I turned round again. ‘I can't hear a word!' I said angrily. ‘It's none of your business",
        translation:
          "上星期我去看戏。我的座位很好，戏很有意思，但我却无法欣赏。 一青年男子与一青年女子坐在我的身后， 大声地说着话。我非常生气，因为我听不见演员在说什么。 我回过头去怒视着那一男一女，他们却毫不理会。 最后， 我忍不住了， 又一次回过头去， 生气地说",
        words: [
          {
