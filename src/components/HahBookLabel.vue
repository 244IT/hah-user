    ...
    <div class="label-list" v-for="label in labels" :key="label.id">
      ...
      >
        <div class="label-item-left">
          <img class="label-item-img" :src="series.img" />
        </div>
...
.label-list {
  ...
  .actived {
    background-color: rgba(52, 167, 255, 0.07);
...
.label-item {
  ...
  &-left {
    ...
    &::after {
      ...
      width: 100%;
      height: 100px;
      background: url("https://k12-teaching-cdn.unipus.cn/digital-platform/online/k12-digit/static/img/home_bg.3a56119.png")
        no-repeat;
